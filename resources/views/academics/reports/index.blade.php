            ...
            @if($selectedSection)
                <div class="card card-outline card-success">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h3 class="card-title">Students in: <strong>{{ $selectedSection->name }}</strong></h3>

                        <div class="card-tools">
                            <a href="{{ route('reports.batch', $selectedSection->id) }}" class="btn btn-success btn-sm font-weight-bold shadow-sm">
                            ...
                            <tbody>
                                @forelse($students as $index => $student)
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <a href="{{ route('reports.single', $student->id) }}" class="btn btn-sm btn-outline-danger">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center p-4">No students found in this class.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
