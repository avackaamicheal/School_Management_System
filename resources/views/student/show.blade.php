                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <div class="d-flex flex-wrap justify-content-sm-end">
                            <a href="{{ route('student.edit', $student->id) }}" class="btn btn-warning shadow-sm mr-1 mr-sm-2">
                                <i class="fas fa-edit mr-1"></i> Edit
                            </a>
                            <a href="{{ route('student.index') }}" class="btn btn-outline-secondary mr-1">
                            ...
                            <div class="card shadow-sm">
                                <div class="card-header bg-light">
                                    <h3 class="card-title font-weight-bold"><i
                                            class="fas fa-map-marker-alt text-danger mr-2"></i> Address</h3>
                                </div>
                                        ...
                                        <div class="row mb-3 {{ !$loop->last ? 'border-bottom pb-3' : '' }}">
                                            ...
                                            @if ($parent->pivot->relationship)
                                                <div class="col-12 mt-2">
                                                    <span
                                                        class="badge badge-info">{{ $parent->pivot->relationship }}</span>
                                                </div>
                                            @endif
                                        </div>
                                    @endforeach
