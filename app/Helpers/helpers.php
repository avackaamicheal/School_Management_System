...
if (!function_exists('resolveRoute')) {
    function resolveRoute(string $name, mixed $params = [], ?\App\Models\User $user = null): string
    {
        ...
        $map = [
            ...
            'grades.index' => ['Teacher' => 'teacher.grades.index'],
            'grades.store' => ['Teacher' => 'teacher.grades.store'],
            ...
            'announcements.index' => ['Teacher' => 'teacher.announcements.index', 'SchoolAdmin' => 'admin.announcements.index', 'Parent' => 'parent.announcements.index'],
            ...
            'messages.index' => ['Teacher' => 'teacher.messages.index', 'SchoolAdmin' => 'admin.messages.index', 'Parent' => 'parent.messages.index'],
            'messages.show' => ['Teacher' => 'teacher.messages.show', 'SchoolAdmin' => 'admin.messages.show', 'Parent' => 'parent.messages.show'],
            'messages.store' => ['Teacher' => 'teacher.messages.store', 'SchoolAdmin' => 'admin.messages.store', 'Parent' => 'parent.messages.store'],
            'messages.thread.create' => ['Teacher' => 'teacher.messages.thread.create', 'SchoolAdmin' => 'admin.messages.thread.create', 'Parent' => 'parent.messages.thread.create'],
